...
import static hei.school.minou.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.minou.PojaGenerated;
import hei.school.minou.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.school.minou.event1";
    return "hei.school.minou.event2";
  }
}
